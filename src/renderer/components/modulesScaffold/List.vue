 ...
 <v-card-text> 
                    ...
                    <v-container>
                      <v-alert
                        ...
                        title="Scaffold list"
                        text="The 'list' scaffolding command is used to generate files that implement the logic for storing and interacting with data stored as a list in the blockchain state."
                      ></v-alert>
                      <v-row>
                        <v-col cols="12">
                          <v-text-field
                            v-model="scafoldListName"
                            label="List name"
                            required
                            variant="outlined"
                          ></v-text-field>
...
export default {
  ...
  methods: {
    async scaffoldNow() {
      console.log(this.textFields, this.scafoldListName)
      let finalField = ''
